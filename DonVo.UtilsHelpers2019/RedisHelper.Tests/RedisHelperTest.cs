...
namespace RedisHelper.Tests
{
    public class RedisHelperTest
    {
        ...
        private readonly RedisHelper _redis =
            ...
            new RedisHelper("127.0.0.1:6379,ssl=False,allowAdmin=True,abortConnect=False,defaultDatabase=0,connectTimeout=500,connectRetry=3");
        ...
        public async Task SortedSetTestAsync()
        {
            ...
            //Return to the top five, no matter how many points
            ...
            //Return the top five between 6-10 points
            var highScore =
